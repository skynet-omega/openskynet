...
If you believe you've found a security issue in OpenSkyNet or a shared OpenClaw-derived component, please report it privately.

## Reporting

Report vulnerabilities directly to the repository where the issue lives:

- **OpenSkyNet repository** — [skynet-omega/openskynet](https://github.com/skynet-omega/openskynet)
- **Shared core CLI and gateway surfaces inherited from OpenClaw** — [openclaw/openclaw](https://github.com/openclaw/openclaw)
...
For issues that clearly belong to this repository, use the OpenSkyNet repo. For shared-platform issues, or if you're unsure, email **[security@openclaw.ai](mailto:security@openclaw.ai)** and we'll route it.
