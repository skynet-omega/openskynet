...
export async function spawnSubagentDirect(
  ...
  const announceOnCompletion = params.announceOnCompletion !== false;
  ...
  if (typeof params.extraSystemPrompt === "string" && params.extraSystemPrompt.trim()) {
