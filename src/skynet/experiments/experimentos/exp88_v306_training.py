"""
Exp88_V7: V306 Closed Loop Hybrid Training
==========================================

Goal: Train the V306 architecture using a Dual Loss function.
"""
...
REPORT_PATH = Path("exp88_v306_training_status.json")
...
def run_training():
    print("--- OPEN SKYNET: V306 CLOSED LOOP HYBRID TRAINING ---")
    ...
    if CHECKPOINT_PATH.exists():
        print(f"  Resuming from existing V306 brain...")
        model.load_checkpoint(CHECKPOINT_PATH)

    optimizer = torch.optim.Adam(model.parameters(), lr=3e-4)
    model.train()
    
    print("  Phase 1: Hybrid Unsupervised Learning (100 steps)")
    ...
    print("  Phase 2: Hybrid Instruct Tuning (100 steps)")
    for step in range(1, 101):
