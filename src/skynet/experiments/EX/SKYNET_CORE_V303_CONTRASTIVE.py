"""
SKYNET CORE V303: CONTRASTIVE HOLOGRAPHIC (InfoNCE Concept Training)
====================================================================

Upgrades from V302:
1. Contrastive Concept Loss (InfoNCE): Prevents representation collapse by 
   pushing the predicted concept vector closer to the target word's embedding
   while simultaneously pushing it away from in-batch negative examples.
2. Temperature Scaling: A learnable temperature parameter to sharpen the 
...
class SKYNET_CORE_V303_CONTRASTIVE(nn.Module):
    def __init__(self, vocab_size=250002, d_model=512, n_organs=32, 
        ...
        if pretrained_embeds is not None:
            ...
            print(f"  [V303] Inherited {vocab_size} embeddings for Semantic Anchoring.")
            
        # Freeze embeddings during contrastive training to maintain a stable semantic anchor
