const DEFAULT_TAGLINE = "All your sessions, one OpenSkynet 🤖";
...
const TAGLINES: string[] = [
  ...
  "Turn ambiguous ideas into tested progress. 🤖",
  ...
  "The pro-active brain in your shell. 🤖",
  ...
  "You had me at 'openskynet gateway start.'",
