  ...
  it("closes the autonomous loop: Failure -> Global Memory -> Agenda -> Induced Hypothesis", async () => {
    ...
    const mockSync = vi
      ...
      .mockResolvedValue({
        ...
        memory: {
          recentOperationalStalls: 0,
          operationalHealth: "nominal",
          highestDurableUtility: 0,
          unintegratedDurableMemories: 0,
        },
        runtime: {
          ...
          dispatchPlan: {
            ...
            expectedUtility: 1,
            utilityBreakdown: { taskCompletion: 0, learning: 1, maintenance: 0, recovery: 0 },
            budgetUsage: {
              budgetPressure: 0,
              recentTurnCostMs: 0,
              observedTurns: 0,
